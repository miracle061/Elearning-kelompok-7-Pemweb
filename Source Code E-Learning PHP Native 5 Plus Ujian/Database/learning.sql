...
--
-- Host: 127.0.0.1
-- Generation Time: 25 Mar 2022 pada 14.27
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
CREATE TABLE IF NOT EXISTS `kelas_ujianessay` (
...
CREATE TABLE IF NOT EXISTS `tb_jenisperangkat` (
...
CREATE TABLE IF NOT EXISTS `tb_jenistugas` (
...
CREATE TABLE IF NOT EXISTS `tb_jenisujian` (
...
CREATE TABLE IF NOT EXISTS `tb_master_jurusan` (
`id_jurusan` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_master_kelas` (
`id_kelas` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_master_semester` (
...
CREATE TABLE IF NOT EXISTS `tb_roleguru` (
`id_roleguru` int(11) NOT NULL,
  `id_guru` int(11) NOT NULL,
  `id_kelas` int(11) NOT NULL,
  `id_mapel` int(11) NOT NULL,
...
(1, '12345678', 'KARIM BENZEMA', 'L', '7c222fb2927d828af22f592134e8932480637c0d', 'off', 'Y', '0', '1648213027-tiny-winny.jpg', 19, 8, 'Yes'),
...
CREATE TABLE IF NOT EXISTS `ujian_essay` (
`id_ujianessay` int(11) NOT NULL,
  `judul` varchar(50) NOT NULL,
  `tanggal` date NOT NULL,
  `jml_soal` int(30) NOT NULL,
...
ALTER TABLE `tb_materi`
 ADD PRIMARY KEY (`id_materi`), ADD KEY `id_roleguru` (`id_roleguru`);

--
-- Indexes for table `tb_perangkat`
--
ALTER TABLE `tb_perangkat`
 ADD PRIMARY KEY (`id_perangkat`), ADD KEY `id_roleguru` (`id_roleguru`);

--
-- Indexes for table `tb_roleguru`
--
ALTER TABLE `tb_roleguru`
 ADD PRIMARY KEY (`id_roleguru`), ADD KEY `id_guru` (`id_guru`), ADD KEY `id_kelas` (`id_kelas`), ADD KEY `id_mapel` (`id_mapel`), ADD KEY `id_semester` (`id_semester`), ADD KEY `id_jurusan` (`id_jurusan`);
...
ALTER TABLE `tb_siswa`
 ADD PRIMARY KEY (`id_siswa`), ADD KEY `id_kelas` (`id_kelas`), ADD KEY `id_jurusan` (`id_jurusan`);
...
--
ALTER TABLE `soal`
MODIFY `id_soal` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=116;
--
